...
export const Intro = () => {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        <span className="font-bold">Hello, I'm Hassanjadi.</span> I'm a{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/hassanjadi/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          className="bg-white text-gray-700 p-4 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10"
          href="https://github.com/Hassanjadi"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
